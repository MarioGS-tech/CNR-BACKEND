...
public class Permission implements Serializable {
    ...
    @JoinTable(name = "CNRPOS_PERMISOS_MENU_ITEMS", joinColumns = @JoinColumn(name = "ID_PERMISSIONS", referencedColumnName = "ID_PERMISSIONS"), inverseJoinColumns = @JoinColumn(name = "ID_MENU_ITEMS", referencedColumnName = "ID_MENU_ITEMS"))
