...
public class TransaccionController {
    ...
    public TransaccionController(RcatalogoService rcatalogoService, TransaccionService transaccionService,
                                 SucursalService sucursalService, CompanyService companyService, AuthenticationService authenticationService,
                                 RestTemplate restTemplate, DocumentoAsociadoService documentoAsociadoService) {
        ...
        // this.urlClientes="https://api-desa.cnr.gob.sv/apifacturael/api/consulta/clientes";
        // this.urlProductos="https://api-desa.cnr.gob.sv/apifacturael/api/consulta/productos";
    }
