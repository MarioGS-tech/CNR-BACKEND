...
@Data
@Entity
@Table(name = "CNRPOS_CUERPO_DOC_CR")
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CuerpoDocCR {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_CNRPOS_CUERPO_DOC_CR")
    @SequenceGenerator(name = "SQ_CNRPOS_CUERPO_DOC_CR", sequenceName = "SQ_CNRPOS_CUERPO_DOC_CR", allocationSize = 1)
