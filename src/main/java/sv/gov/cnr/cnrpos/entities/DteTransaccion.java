...
@Data
@Entity
@Table(name = "CNRPOS_DTE_TRANSACCION")
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DteTransaccion {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DTE_TRANSACCION_SEQ")
    @SequenceGenerator(name = "DTE_TRANSACCION_SEQ", sequenceName = "DTE_TRANSACCION_SEQ", allocationSize = 1)
    ...
    @Lob
    @Column(name = "DTE_JSON", columnDefinition = "CLOB")
    private String dteJson;

    @Lob
    @Column(name = "DTE_JSON_FIRMADO", columnDefinition = "CLOB")
