...
public class Menu implements Serializable {
    ...
    @JoinTable(name = "CNRPOS_MENU_MENU_ITEMS", joinColumns = @JoinColumn(name = "ID_MENU", referencedColumnName = "ID_MENU"), inverseJoinColumns = @JoinColumn(name = "ID_MENU_ITEMS", referencedColumnName = "ID_MENU_ITEMS"))
